...
-- currently logs out when create collection

-- need to put a "add to collection" drop down on recipe page
-- need to add "rename", "delete" to sidebar collections
-- need to add "delete recipe" from collection view
...
-- form authenticity token for backbone views